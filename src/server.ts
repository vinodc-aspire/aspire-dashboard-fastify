...
import { testAccountsRoutes } from "./routes/testAccounts.routes";
...
export async function buildServer() {
    ...
    logger: {
      transport: {
        ...
        options: {
          ...
          messageFormat:
            "{req.method} {req.url} {res.statusCode} — {msg} [{responseTime}ms]",
  ...
  app.register(testAccountsRoutes, { prefix: "/api" });
